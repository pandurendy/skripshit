...
$sql = "select * from view_progres_marking where id_progres = '$vid' " ;
				...
				<div id="my-tabs-content" class="tab-content">
					<div id="infoDetail" class="tab-pane fade in active">
						...
						<tr valign="baseline">
							...
							<td><input type="text" class="form-control" name="catatan_kadiv" value="<?php echo htmlentities($data['catatan_kadiv'], ENT_COMPAT, 'utf-8'); ?>" size="32"  /></td>
						</tr>
						<tr valign="baseline">
...
if ((isset($_POST['add'])) or (isset($_POST['delete'])) or (isset($_POST['update'])) ) {
	...
	$vcatatan_kadiv = $_POST['catatan_kadiv'];
